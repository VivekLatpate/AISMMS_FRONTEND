    ...
    <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
      {summaryCards.map((card) => {
        ...
        return (
          ...
          >
            <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-green-600 via-gray-300 to-green-600" />
            ...
            <div className="flex items-start justify-between gap-3 pt-2">
              <div className="space-y-2">
                ...
                <p className="inline-flex items-center rounded-full bg-slate-900/5 px-3 py-1 text-xs font-medium text-slate-700 dark:bg-slate-800/70 dark:text-slate-200">
                  <span className="mr-2 h-1.5 w-1.5 rounded-full bg-gradient-to-r from-green-600 to-orange-400" />
                  {card.chip}
                </p>
              </div>
              ...
              <div className="flex flex-col items-end gap-2">
                <span
                  className={`inline-flex items-center rounded-full px-2.5 py-1 text-xs font-semibold ${card.positive
                ...
                <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-slate-900/5 text-green-700 dark:bg-slate-800/80 dark:text-green-300">
